...
-- CreateEnum
CREATE TYPE "MediaType" AS ENUM ('IMAGE', 'VIDEO', 'AUDIO', 'FACE_SWAP', 'VIDEO_FACE_SWAP', 'DOCUMENT', 'OTHER');

-- CreateEnum
CREATE TYPE "MediaStatus" AS ENUM ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'REJECTED');
...
CREATE TABLE "FaceSwapJob" (
    ...
    "resultUrl" TEXT,
    "status" "MediaStatus" NOT NULL DEFAULT 'PENDING',
    "model" TEXT NOT NULL DEFAULT 'insightface',
    "parameters" JSONB,
    "error" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    ...
    CONSTRAINT "FaceSwapJob_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "VideoFaceSwapJob" (
    "id" TEXT NOT NULL,
    "workspaceId" TEXT NOT NULL,
    "brandId" TEXT NOT NULL,
    "sourceFaceUrl" TEXT NOT NULL,
    ...
    CONSTRAINT "VideoFaceSwapJob_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "MediaAsset_workspaceId_brandId_idx" ON "MediaAsset"("workspaceId", "brandId");
...
-- CreateIndex
CREATE INDEX "FaceSwapJob_workspaceId_brandId_idx" ON "FaceSwapJob"("workspaceId", "brandId");

-- CreateIndex
CREATE INDEX "FaceSwapJob_workspaceId_status_idx" ON "FaceSwapJob"("workspaceId", "status");

-- CreateIndex
CREATE INDEX "VideoProject_workspaceId_brandId_idx" ON "VideoProject"("workspaceId", "brandId");

-- CreateIndex
CREATE INDEX "VideoProject_workspaceId_status_idx" ON "VideoProject"("workspaceId", "status");

-- CreateIndex
CREATE INDEX "VideoFaceSwapJob_workspaceId_brandId_idx" ON "VideoFaceSwapJob"("workspaceId", "brandId");

-- CreateIndex
CREATE INDEX "VideoFaceSwapJob_workspaceId_status_idx" ON "VideoFaceSwapJob"("workspaceId", "status");

-- CreateIndex
CREATE INDEX "NewsSource_workspaceId_active_idx" ON "NewsSource"("workspaceId", "active");

-- CreateIndex
CREATE INDEX "NewsSource_brandId_idx" ON "NewsSource"("brandId");

-- CreateIndex
CREATE UNIQUE INDEX "NewsSource_workspaceId_url_key" ON "NewsSource"("workspaceId", "url");

-- CreateIndex
CREATE UNIQUE INDEX "NewsArticle_url_key" ON "NewsArticle"("url");

-- CreateIndex
CREATE INDEX "NewsArticle_workspaceId_brandId_idx" ON "NewsArticle"("workspaceId", "brandId");

-- CreateIndex
CREATE INDEX "NewsArticle_workspaceId_category_idx" ON "NewsArticle"("workspaceId", "category");

-- CreateIndex
CREATE INDEX "NewsArticle_sourceId_idx" ON "NewsArticle"("sourceId");

-- CreateIndex
CREATE INDEX "NewsArticle_workspaceId_createdAt_idx" ON "NewsArticle"("workspaceId", "createdAt");
...
-- AddForeignKey
ALTER TABLE "FaceSwapJob" ADD CONSTRAINT "FaceSwapJob_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FaceSwapJob" ADD CONSTRAINT "FaceSwapJob_brandId_fkey" FOREIGN KEY ("brandId") REFERENCES "Brand"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "VideoFaceSwapJob" ADD CONSTRAINT "VideoFaceSwapJob_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VideoFaceSwapJob" ADD CONSTRAINT "VideoFaceSwapJob_brandId_fkey" FOREIGN KEY ("brandId") REFERENCES "Brand"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "NewsArticle" ADD CONSTRAINT "NewsArticle_brandId_fkey" FOREIGN KEY ("brandId") REFERENCES "Brand"("id") ON DELETE CASCADE ON UPDATE CASCADE;
